...
# 檔案名稱 : ui_monitor.py
# 程式版本 : ui_v1.2.1 (Phase 4.1: 修復 Markdown 縮排渲染)
#
# 📋 進版說明 (Version Notes):
#   1. [UI 修復] 徹底移除 HTML 字串前方的空白縮排，解決 Streamlit 誤判為程式碼區塊 (Code Block) 的顯示崩潰問題。
#   2. [功能維持] 原有底色脫鉤、台美股動態顏色判定 100% 保留。
#
# 🏷️ 區塊說明 (Block Description):
#   - 1️⃣ 資料獲取與快取防護罩
#   - 2️⃣ 介面渲染主程式
#   - 3️⃣ 動態狀態機與 HTML 小卡生成 (🔥 V1.2.1 縮排修復區塊)
# ⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐
# ==========================================================
                ...
                with cols[j]:
                    if ticker in quotes:
                        ...
                        if ticker_alerts:
                            ...
                            # 🔥 V1.2.1 修復：字串靠左貼齊，防止 Streamlit 渲染崩潰
                            badge_html = f"""
